...
//     // $('.first').add('second').css('background','red')
//     // $('.first').addBack()('second')
...
//     $('.animate').click(function(alert){
//       $('div').slideUp(5000,function alert(){
// alert('Up')
//       })
//     }
